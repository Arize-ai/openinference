...
async function buildSlackMessage(github, context, issueGroups, lookbackDays) {
  const messageLines = [
    `*🛠️ OpenInference Customer Issues Opened in the Last ${lookbackDays} Day(s) Pending <https://github.com/Arize-ai/openinference/issues?q=is%3Aissue+is%3Aopen+label%3Atriage|Triage>*\n`
  ];
