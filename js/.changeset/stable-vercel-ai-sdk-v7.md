...
This also updates the package to target the stable AI SDK v7 package set, require Node.js 22 or newer, and publish ESM-only entrypoints. AI SDK v6 or CommonJS users should remain on the latest v2 release of `@arizeai/openinference-vercel`.
