...
/** Token count for the text generated by the model (in tokens) */
export const LLM_TOKEN_COUNT_COMPLETION_DETAILS_TEXT =
  `${SemanticAttributePrefixes.llm}.${LLMAttributePostfixes.token_count}.completion_details.text` as const;
...
export const SemanticConventions = {
  ...
  LLM_TOKEN_COUNT_COMPLETION_DETAILS_TEXT,
