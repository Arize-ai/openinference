 ...
 * These are attributes that supplement the standard gen_ai.* conventions.
 *
 * AI SDK v6 emits both:
 * - gen_ai.* attributes (OpenTelemetry GenAI semantic conventions) - handled by openinference-genai
 * - ai.* attributes (Vercel-specific) - handled here
 *
...
/**
 * The semantic conventions used by the Vercel AI SDK v6.
 * These are Vercel-specific attributes that supplement the standard gen_ai.* conventions.
 * @see https://sdk.vercel.ai/docs/ai-sdk-core/telemetry#collected-data
 */
...
/**
 * List of all Vercel AI semantic convention values.
 * Used for iteration when processing attributes.
 */
export const VercelAISemanticConventionsList = Object.freeze(
  Object.values(VercelAISemanticConventions),
);

export type VercelAISemanticConvention = ValueOf<
  typeof VercelAISemanticConventions
>;

// Re-export for backward compatibility during migration
// TODO: Remove these aliases in a future version
export const AISemanticConventions = VercelAISemanticConventions;
export const AISemanticConventionsList = VercelAISemanticConventionsList;
export type AISemanticConvention = VercelAISemanticConvention;
