...
public final class SpanAttributes {
    ...
    public static final AttributeKey<String> LLM_INVOCATION_PARAMETERS = AttributeKey.stringKey("llm.invocation_parameters");
    ...
    public static final AttributeKey<String> LLM_PROMPT_TEMPLATE = AttributeKey.stringKey("llm.prompt_template.template");
    public static final AttributeKey<String> LLM_PROMPT_TEMPLATE_VARIABLES = AttributeKey.stringKey("llm.prompt_template.variables");
    public static final AttributeKey<String> LLM_PROMPT_TEMPLATE_VERSION = AttributeKey.stringKey("llm.prompt_template.version");
    
    // LLM request parameters
    public static final AttributeKey<Double> LLM_REQUEST_TEMPERATURE = AttributeKey.doubleKey("llm.request.temperature");
    ...
    public static final AttributeKey<Double> LLM_REQUEST_FREQUENCY_PENALTY = AttributeKey.doubleKey("llm.request.frequency_penalty");
    public static final AttributeKey<Double> LLM_REQUEST_PRESENCE_PENALTY = AttributeKey.doubleKey("llm.request.presence_penalty");
    public static final AttributeKey<String> LLM_REQUEST_STOP_SEQUENCES = AttributeKey.stringKey("llm.request.stop_sequences");
    public static final AttributeKey<Long> LLM_REQUEST_SEED = AttributeKey.longKey("llm.request.seed");
    
    // LLM token count attributes
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_COMPLETION = AttributeKey.longKey("llm.token_count.completion");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_COMPLETION_DETAILS_AUDIO = AttributeKey.longKey("llm.token_count.completion_details.audio");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_COMPLETION_DETAILS_REASONING = AttributeKey.longKey("llm.token_count.completion_details.reasoning");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_PROMPT = AttributeKey.longKey("llm.token_count.prompt");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_PROMPT_DETAILS_AUDIO = AttributeKey.longKey("llm.token_count.prompt_details.audio");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_INPUT = AttributeKey.longKey("llm.token_count.prompt_details.cache_input");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_READ = AttributeKey.longKey("llm.token_count.prompt_details.cache_read");
    public static final AttributeKey<Long> LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_WRITE = AttributeKey.longKey("llm.token_count.prompt_details.cache_write");
    ...
    public static final AttributeKey<Double> LLM_COST_COMPLETION_DETAILS_AUDIO = AttributeKey.doubleKey("llm.cost.completion_details.audio");
    public static final AttributeKey<Double> LLM_COST_COMPLETION_DETAILS_OUTPUT = AttributeKey.doubleKey("llm.cost.completion_details.output");
    public static final AttributeKey<Double> LLM_COST_COMPLETION_DETAILS_REASONING = AttributeKey.doubleKey("llm.cost.completion_details.reasoning");
    public static final AttributeKey<Double> LLM_COST_PROMPT = AttributeKey.doubleKey("llm.cost.prompt");
    public static final AttributeKey<Double> LLM_COST_PROMPT_DETAILS_AUDIO = AttributeKey.doubleKey("llm.cost.prompt_details.audio");
    public static final AttributeKey<Double> LLM_COST_PROMPT_DETAILS_CACHE_INPUT = AttributeKey.doubleKey("llm.cost.prompt_details.cache_input");
    public static final AttributeKey<Double> LLM_COST_PROMPT_DETAILS_CACHE_READ = AttributeKey.doubleKey("llm.cost.prompt_details.cache_read");
    public static final AttributeKey<Double> LLM_COST_PROMPT_DETAILS_CACHE_WRITE = AttributeKey.doubleKey("llm.cost.prompt_details.cache_write");
    public static final AttributeKey<Double> LLM_COST_PROMPT_DETAILS_INPUT = AttributeKey.doubleKey("llm.cost.prompt_details.input");
    ...
    public static final AttributeKey<String> OPENINFERENCE_SPAN_KIND = AttributeKey.stringKey("openinference.span.kind");
    ...
    // Response attributes
    public static final AttributeKey<String> LLM_RESPONSE_FINISH_REASONS = AttributeKey.stringKey("llm.response.finish_reasons");
