...
public final class MessageAttributes {
    ...
    public static final AttributeKey<String> MESSAGE_FUNCTION_CALL_NAME = AttributeKey.stringKey("message.function_call_name");
    public static final AttributeKey<String> MESSAGE_FUNCTION_CALL_ARGUMENTS_JSON = AttributeKey.stringKey("message.function_call_arguments_json");
