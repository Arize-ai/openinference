...
public class SemanticConventions {
     ...
     */
    public static final String INPUT_VALUE =
            SemanticAttributePrefixes.INPUT + ".value";

    public static final String INPUT_MIME_TYPE =
            SemanticAttributePrefixes.INPUT + ".mime_type";

    /**
     * The output of any span
     */
    public static final String OUTPUT_VALUE =
            SemanticAttributePrefixes.OUTPUT + ".value";

    public static final String OUTPUT_MIME_TYPE =
            SemanticAttributePrefixes.OUTPUT + ".mime_type";
     ...
     */
    public static final String LLM_MODEL_NAME =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.MODEL_NAME;
     ...
     */
    public static final String MESSAGE_ROLE =
            SemanticAttributePrefixes.MESSAGE + "." + MessageAttributePostfixes.ROLE;
     ...
     * @see <a href="https://beta.openai.com/docs/api-reference/completions/create">OpenAI API Reference</a>
     */
    public static final String LLM_PROMPTS =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.PROMPTS;
    ...
    public static final String LLM_PROVIDER =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.PROVIDER;

    /**
     * The AI product as identified by the client or server
     */
    public static final String LLM_SYSTEM =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.SYSTEM;
     ...
     */
    public static final String LLM_COST =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.COST;
    ...
    public static final String MESSAGE_NAME =
            SemanticAttributePrefixes.MESSAGE + "." + MessageAttributePostfixes.NAME;
     ...
     */
    public static final String TOOL_CALL_ID =
            SemanticAttributePrefixes.TOOL_CALL + "." + ToolCallAttributePostfixes.ID;
    ...
    public static final String IMAGE_URL =
            SemanticAttributePrefixes.IMAGE + "." + ImageAttributesPostfixes.URL;

    public static final String DOCUMENT_ID =
            SemanticAttributePrefixes.DOCUMENT + "." + DocumentAttributePostfixes.ID;
    ...
    public static final String PROMPT_TEMPLATE_VARIABLES =
            PROMPT_TEMPLATE_PREFIX + ".variables";

    /**
     * A prompt template
     */
    public static final String PROMPT_TEMPLATE_TEMPLATE =
            PROMPT_TEMPLATE_PREFIX + ".template";

    /**
     * A prompt template version
     */
    public static final String PROMPT_TEMPLATE_VERSION =
            PROMPT_TEMPLATE_PREFIX + ".version";
     ...
     */
    public static final String LLM_TOOLS =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.TOOLS;

    /**
     * The name of a tool
     */
    public static final String TOOL_NAME =
            SemanticAttributePrefixes.TOOL + "." + ToolAttributePostfixes.NAME;
    ...
    public static final String SESSION_ID =
            SemanticAttributePrefixes.SESSION + "." + SessionAttributePostfixes.ID;

    /**
     * The user id of a trace. Used to correlate spans for a single user.
     */
    public static final String USER_ID =
            SemanticAttributePrefixes.USER + "." + UserAttributePostfixes.ID;
    ...
    public static final String TAG_TAGS =
            SemanticAttributePrefixes.TAG + "." + TagAttributePostfixes.TAGS;

    /**
     * The url of an audio file
     */
    public static final String AUDIO_URL =
            SemanticAttributePrefixes.AUDIO + "." + AudioAttributesPostfixes.URL;
     ...
     */
    public static final String PROMPT_VENDOR =
            SemanticAttributePrefixes.PROMPT + "." + PromptAttributePostfixes.VENDOR;

    /**
     * A vendor-specific id used to locate the prompt
     */
    public static final String PROMPT_ID =
            SemanticAttributePrefixes.PROMPT + "." + PromptAttributePostfixes.ID;

    /**
     * A vendor-specific URL used to locate the prompt
     */
    public static final String PROMPT_URL =
            SemanticAttributePrefixes.PROMPT + "." + PromptAttributePostfixes.URL;
    ...
    public static final String AGENT_NAME =
            SemanticAttributePrefixes.AGENT + "." + AgentPostfixes.NAME;

    /**
     * The id of the node in the execution graph. This along with graph.node.parent_id are used to visualize the execution graph.
     */
    public static final String GRAPH_NODE_ID =
            SemanticAttributePrefixes.GRAPH + "." + GraphPostfixes.NODE_ID;

    /**
     * The name of the node in the execution graph. Use this to present a human readable name for the node. Optional
     */
    public static final String GRAPH_NODE_NAME =
            SemanticAttributePrefixes.GRAPH + "." + GraphPostfixes.NODE_NAME;
    ...
    public static final String OPENINFERENCE_SPAN_KIND =
            SemanticAttributePrefixes.OPENINFERENCE + ".span.kind";
