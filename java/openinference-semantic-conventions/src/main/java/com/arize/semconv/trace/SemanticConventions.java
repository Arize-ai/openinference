...
public class SemanticConventions {
    ...
    public static final String LLM_TOKEN_COUNT_COMPLETION_DETAILS_TEXT =
            SemanticAttributePrefixes.LLM + "." + LLMAttributePostfixes.TOKEN_COUNT + ".completion_details.text";
