...
class LLMSpanTest {
    ...
    void setsLLMSpanKindAndModelAttributes() {
        try (LLMSpan span = LLMSpan.start(tracer, "test-llm")) {
    ...
    void hideInputMessagesRespected() {
        ...
        try (LLMSpan span = LLMSpan.start(maskedTracer, "masked-llm")) {
    ...
    void setsOutputMessages() {
        try (LLMSpan span = LLMSpan.start(tracer, "output-msg")) {
    ...
    void hideOutputMessagesRespected() {
        ...
        try (LLMSpan span = LLMSpan.start(maskedTracer, "masked-output")) {
    ...
    void setsInvocationParameters() {
        try (LLMSpan span = LLMSpan.start(tracer, "invocation-params")) {
    ...
    void setsCostAttributes() {
        try (LLMSpan span = LLMSpan.start(tracer, "cost-test")) {
    ...
    void setsProviderAttribute() {
        try (LLMSpan span = LLMSpan.start(tracer, "provider-test")) {
    ...
    void setsInputMessagesWhenNotHidden() {
        try (LLMSpan span = LLMSpan.start(tracer, "visible-input-msg")) {
