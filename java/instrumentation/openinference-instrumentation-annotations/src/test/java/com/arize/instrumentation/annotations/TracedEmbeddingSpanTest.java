...
class TracedEmbeddingSpanTest {
    ...
    void setsEmbeddingSpanKind() {
        try (TracedEmbeddingSpan span = TracedEmbeddingSpan.start(tracer, "test-embedding")) {
    ...
    void hideOutputEmbeddingsRespected() {
        ...
        try (TracedEmbeddingSpan span = TracedEmbeddingSpan.start(maskedTracer, "masked-embedding")) {
