...
public class ModelProvider {
    ...
    static {
        ...
        // OpenAI
        MODEL_PATTERNS.put(
                Pattern.compile("(?i)(^chatgpt-4o-latest|" +
                        "^gpt-(35|3.5)-turbo|" +
        ...
        // Anthropic
        MODEL_PATTERNS.put(Pattern.compile("(?i)(^claude-3-5-haiku-20241022|anthropic\\.claude-3-5-haiku-20241022-v1:0|claude-3-5-haiku-V1@20241022|" +
                        ...
                        "^claude-sonnet-4-20250514|anthropic\\.claude-sonnet-4-20250514-v1:0|claude-sonnet-4@20250514)"), Provider.ANTHROPIC.name());

        // Google
        MODEL_PATTERNS.put(Pattern.compile("(?i)(^gemini-2.0-flash(@[a-zA-Z0-9]+)?|" +
                        "^gemini-2.0-flash-001(@[a-zA-Z0-9]+)?|" +
                        ...
                        "^gemini-2\\.5-pro-preview-tts)"), Provider.GOOGLE.name());
    }
