...
public class TraceConfig {
    ...
    public boolean isHideOutputImages() {
        return hideOutputImages;
    }
    ...
    public boolean isHideInputAudio() {
        return hideInputAudio;
    }

    public boolean isHideOutputAudio() {
        return hideOutputAudio;
    }

    public boolean isHideInputEmbeddings() {
        return hideInputEmbeddings;
    }

    public boolean isHideOutputEmbeddings() {
        return hideOutputEmbeddings;
    }

    public boolean isHidePromptTemplate() {
        return hidePromptTemplate;
    }

    public boolean isHidePromptTemplateVariables() {
        return hidePromptTemplateVariables;
    }

    public boolean isHidePromptTemplateVersion() {
        return hidePromptTemplateVersion;
    }

    public boolean isHideToolParameters() {
        return hideToolParameters;
    }

    public String getBase64ImageMaxLength() {
