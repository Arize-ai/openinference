...
# ]
# ///
"""openai-agents realtime span-root audio keys as published SpanAttributes.

Current and future use the same attribute names. The future span must not grow llm.input_messages.
"""
