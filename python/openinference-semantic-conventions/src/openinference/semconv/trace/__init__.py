...
class SpanAttributes:
    ...
    """
    Number of input tokens in the prompt that were cached.
    """
    ...
    """
    Custom JSON object containing any additional details about the prompt tokens.
    This allows users to send any prompt token-related information they want to track.
    """
    LLM_TOKEN_COUNT_COMPLETION_DETAILS = "llm.token_count.completion_details"
    """
    Custom JSON object containing any additional details about the completion tokens.
    This allows users to send any completion token-related information they want to track.
    """
    ...
    Cost information for the LLM call. Example structure:
    {
        ...
        "total": 0.0036,
        "completion_details": {
            "reasoning": 0.0012,    # 40 tokens * $0.03/1K
            "audio_output": 0.0006  # 20 tokens * $0.03/1K
        },
        "prompt_details": {
            "cache_write": 0.0003,  # 10 tokens * $0.03/1K
            "cache_read": 0.0003,   # 10 tokens * $0.03/1K
            "cache_input": 0.0003,  # 10 tokens * $0.03/1K
            "audio_input": 0.0003   # 10 tokens * $0.03/1K
        }
    }
