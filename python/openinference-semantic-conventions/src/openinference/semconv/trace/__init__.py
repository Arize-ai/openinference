...
class MessageAttributes:
    ...
    """
    MESSAGE_TOOL_CALL_RESULTS = "message.tool_call_results"
    """
    The tool call results generated by the user.
    """
...
class ToolCallResultAttributes:
    """
    Attributes describing the result of a tool (function) call.
    """

    TOOL_CALL_RESULT_ID = "tool_call_result.id"
    """
    The id for the tool call whose result is being recorded.
    This id should match the corresponding tool call id emitted when the
    tool was invoked, allowing the call and its result to be correlated.
    """
    TOOL_CALL_RESULT_FUNCTION_NAME = "tool_call_result.function.name"
    """
    The name of the function or tool that was executed.
    This should correspond to the function name specified in the tool call request.
    """
    TOOL_CALL_RESULT_FUNCTION_RESULT_VALUE = "tool_call_result.function.result.value"
    """
    The output produced by the function execution.
    """
    TOOL_CALL_RESULT_FUNCTION_RESULT_MIME_TYPE = "tool_call_result.function.result.mime_type"
    """
    The MIME type describing the format of the function result value.
    """
