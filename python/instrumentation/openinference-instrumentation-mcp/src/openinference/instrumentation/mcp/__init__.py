        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                if hasattr(result, 'messages') and result.messages:
                    span.set_attribute(SpanAttributes.OUTPUT_VALUE, safe_json_dumps({
        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                if hasattr(result, 'contents') and result.contents:
                    ...
                    span.set_attribute(SpanAttributes.RETRIEVAL_DOCUMENTS, safe_json_dumps(serialized_contents))
                    span.set_attribute(SpanAttributes.OUTPUT_VALUE, safe_json_dumps({"contents": serialized_contents}))
                    span.set_attribute(SpanAttributes.OUTPUT_MIME_TYPE, "application/json")
