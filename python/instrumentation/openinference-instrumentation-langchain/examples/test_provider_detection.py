...
from openinference.instrumentation.langchain._tracer import parse_provider_and_model, _llm_provider
...
def test_parse_provider_and_model():
    ...
    test_cases = [
        ...
        ("together/meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo", "together", "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo"),
        ("gpt-4", None, "gpt-4"),
...
def test_llm_provider():
    ...
    test_cases = [
        ...
        ({"invocation_params": {"model": "text-completion-openai/gpt-3.5-turbo-instruct"}}, "openai"),
    ...
    for extra, expected_provider in test_cases:
        ...
        if expected_provider is None:
            ...
            result = "✓" if len(provider_items) == 1 and provider_items[0][0] == "llm.provider" and provider_items[0][1] == expected_provider else "✗"
...
def test_with_real_langchain_providers():
    ...
    for provider in providers:
        ...
        try:
            ...
            print(f"  2. Install the required package")
            print(f"  3. Run the import and initialization code")
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if models:
                        ...
                        print(f"✓ Successfully created ChatOllama instance")
...
def test_real_langchain_invocation():
    ...
    # Set up tracing
    tracer_provider = trace_sdk.TracerProvider()
    tracer_provider.add_span_processor(SimpleSpanProcessor(ConsoleSpanExporter()))  # Print spans to console
    ...
    try:
        ...
        print("\nCheck the console output above for the spans generated by the OpenTelemetry instrumentation.")
