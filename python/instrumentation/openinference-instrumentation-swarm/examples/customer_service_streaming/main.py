...
from configs.general import engine_name, persist, test_file, test_root

from src.arg_parser import parse_args
from src.swarm.swarm import Swarm
from src.tasks.task import Task
from src.validator import validate_all_assistants, validate_all_tools
...
def main():
    ...
    if args.test is not None:
        ...
        while True:
            ...
            task_parser.add_argument(
                "--evaluate", action="store_true", help="Set the evaluate flag for the new task."
            )
            task_parser.add_argument(
                "--assistant",
                type=str,
