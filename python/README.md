...
[Phoenix](https://github.com/Arize-ai/phoenix) runs locally on your machine and does not send data over the internet. If you'd rather use a hosted collector, point the same OTLP exporter at [Arize AX](https://arize.com/) instead.
