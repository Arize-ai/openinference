...
if "messages_compiled" not in st.session_state.keys():  # Initialize the chat messages history
...
if st.session_state.messages_compiled[-1]["role"] != "assistant":
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            st.session_state.messages_compiled.append(message)  # Add response to message history
