...
```json
{
    ...
    "attributes": {
        "llm.input_messages": [
            {
                "message.role": "system",
                "message.content": "You are a helpful assistant. You will be asked question about images and will return concise answers\n"
            },
            {
                "message.role": "user",
                "message.content": {
            ...
            },
            {
                ...
                "message.content": {
                    "message_content": {
                        ...
                        "image": {
                            "image": {
                                "url": "https://en.wikipedia.org/wiki/Dog#/media/File:Retriever_in_water.jpg",
                            }
                        }
                    }
                }
        ...
        "llm.invocation_parameters": "{\"model\": \"gpt-4o\"}",
        "output.value": "It is a Golden Retriever.",
        "output.mime_type": "text/plain",
        "llm.output_messages": [
            {
                "message.role": "assistant",
                "message.content": "It is a Golden Retriever."
            }
        ],
        "llm.token_count.prompt": 259,
        "llm.token_count.completion": 14,
