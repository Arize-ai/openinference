...
| ---------------------------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `annotation.annotator_kind`                    | String                      | `"LLM"`                                                                                                                       | Kind of judge that produced an annotation: `HUMAN`, `LLM`, `CODE`, or a custom value                                                                                                |
| `annotation.explanation`                       | String                      | `"The claim is not supported by the context."`                                                                                | Human-readable explanation or evidence for an annotation result                                                                                                                     |
| `annotation.identifier`                        | String                      | `"judge-v2"`                                                                                                                  | Stable identifier for distinguishing or updating annotations with the same name on the same target                                                                                 |
| `annotation.label`                             | String                      | `"hallucinated"`                                                                                                              | Categorical annotation result                                                                                                                                                       |
| `annotation.metadata`                          | JSON String                 | `"{\"evaluator\":\"judge-v2\"}"`                                                                                           | Additional annotation or annotator information                                                                                                                                     |
| `annotation.name`                              | String                      | `"hallucination"`                                                                                                             | Name of the criterion or metric being annotated                                                                                                                                     |
| `annotation.score`                             | Integer/Float               | `1`                                                                                                                           | Numeric annotation result; its range and direction are defined by the annotation name and evaluator                                                                                |
| `annotations`                                  | List of objects<sup>†</sup> | `[{"annotation.name": "hallucination", "annotation.label": "hallucinated"}]`                                                | Feedback attached to the span being judged. Uses flattened attributes (e.g., `annotations.0.annotation.name`). See [Annotations and Evaluations](./annotations.md)                 |
...
| `evaluation.annotator_kind`                    | String                      | `"HUMAN"`                                                                                                                     | Kind of judge that produced an evaluation: `HUMAN`, `LLM`, `CODE`, or a custom value                                                                                                |
| `evaluation.explanation`                       | String                      | `"The response directly answers the question."`                                                                               | Human-readable explanation or evidence for an evaluation result                                                                                                                     |
| `evaluation.identifier`                        | String                      | `"reviewer-42"`                                                                                                               | Stable identifier for distinguishing or updating evaluations with the same name on the same target                                                                                 |
| `evaluation.label`                             | String                      | `"relevant"`                                                                                                                  | Categorical evaluation result                                                                                                                                                       |
| `evaluation.metadata`                          | JSON String                 | `"{\"rubric_version\":\"2\"}"`                                                                                            | Additional evaluation or evaluator information                                                                                                                                     |
| `evaluation.name`                              | String                      | `"relevance"`                                                                                                                 | Name of the criterion or metric being evaluated                                                                                                                                     |
| `evaluation.score`                             | Integer/Float               | `0.95`                                                                                                                        | Numeric evaluation result; its range and direction are defined by the evaluation name and evaluator                                                                                |
| `evaluations`                                  | List of objects<sup>†</sup> | `[{"evaluation.name": "relevance", "evaluation.score": 0.95}]`                                                             | Feedback produced by an `EVALUATOR` span. Uses flattened attributes (e.g., `evaluations.0.evaluation.name`). See [Annotations and Evaluations](./annotations.md)                   |
...
- `annotations.<index>.annotation.<attribute>` - Feedback attached to the span being judged
- `evaluations.<index>.evaluation.<attribute>` - Feedback produced by an `EVALUATOR` span

Both forms share the same result fields and are defined in [Annotations and Evaluations](./annotations.md).
