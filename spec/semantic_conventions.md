...
| `message.contents`                     | List of objects<sup>†</sup> | `[{"message_content.type": "text", "message_content.text": "Hello"}, {...},...]` | The message contents to or from the llm, it is an array of `message_content` objects. |
