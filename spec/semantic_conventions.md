...
| `agent.name`                           | String                      | `researcher`                                                               | The name of the agent that this span represents. Avoid including high cardinality information such as IDs as part of the agent name.                                                                      |
| `agent.step`                           | Integer                     | `1`                                                                        | The step of the current agent in the execution graph.                                                                                                                                                     |
| `agent.parent`                         | String                      | `supervisor`                                                               | The name of the parent agent to the current agent. Leaving this unset or set as empty string implies that the current span is the root agent.                                                             |
| `graph.node.name`                      | String                      | `search_api`                                                               | The name of the current node in the execution graph. Similar to `agent.name` but for general purpose execution graphs. Avoid including high cardinality information such as IDs as part of the node name. |
| `graph.node.step`                      | Integer                     | `1`                                                                        | The step of the current node graph in the execution graph.                                                                                                                                                |
| `graph.node.parent`                    | String                      | `router`                                                                   | The name of the parent node to the current node. Leaving this unset or set as empty string implies that the current span is the root node.                                                                |
