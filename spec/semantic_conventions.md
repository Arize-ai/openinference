...
| `llm.token_count.completion.reasoning` | Integer                     | `10`                                                                       | The number of tokens used for model reasoning                                         |
| `llm.token_count.prompt`               | Integer                     | `10`                                                                       | The number of tokens in the prompt                                                    |
| `llm.token_count.prompt.cached`        | Integer                     | `5`                                                                        | The number of cached tokens used from previous prompts                                |
