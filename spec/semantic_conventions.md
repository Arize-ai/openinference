...
| `annotations`                                  | List of objects<sup>†</sup> | `[{"annotation.name": "hallucination", "annotation.label": "hallucinated"}]`                                                | Feedback about this span, flattened as `annotations.0.annotation.*`. See [Annotations and Evaluations](./annotations.md)                                                           |
...
| `evaluations`                                  | List of objects<sup>†</sup> | `[{"evaluation.name": "relevance", "evaluation.score": 0.95}]`                                                             | Feedback from an `EVALUATOR` span, flattened as `evaluations.0.evaluation.*`. See [Annotations and Evaluations](./annotations.md)                                                  |
