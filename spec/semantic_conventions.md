...
| `agent.parent`                         | String                      | `supervisor`                                                               | The name of the parent agent to the current agent                                                                     |
| `graph.node.name`                      | String                      | `search_api`                                                               | The name of the current node in the execution graph. Similar to `agent.name` but for general purpose execution graphs |
| `graph.node.step`                      | Integer                     | `1`                                                                        | The step of the current node graph in the execution graph.                                                            |
| `graph.node.parent`                    | String                      | `router`                                                                   | The name of the parent node to the current node                                                                       |
