...
| `output.images`                                | List of objects<sup>†</sup> | `[{"image.url": "data:image/png;base64,iVBORw0KGgo..."}]`                                                                     | Images produced by the span, valid on any span kind. Flattened as `output.images.0.image.url`. See [Multimodal Attributes](./multimodal_attributes.md#span-kind-independent-images) |
