...
| `llm.finish_reasons`                           | List of strings             | `["stop"]`, `["stop", "length"]`                                                                                              | Array of reasons the model stopped generating tokens, corresponding to each generation received. Maps to OpenTelemetry GenAI's `gen_ai.response.finish_reasons`.                    |
...
| `message_content.type`                         | String                      | `"text"` or `"image"`                                                                                                         | The type of the content, such as "text" or "image".                                                                                                                                 |
