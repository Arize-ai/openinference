...
| `message_content.audio`                        | Audio Object                | `{"audio.url": "https://example.com/audio.mp3", "audio.mime_type": "audio/mpeg"}`                                              | The audio content of the message, if the type is "audio". Nested leaves are `audio.url`, `audio.mime_type`, and `audio.transcript`.                                                  |
| `message_content.video`                        | Video Object                | `{"video.url": "gs://bucket/clip.mp4", "video.mime_type": "video/mp4"}`                                                        | The video content of the message, if the type is "video". Nested leaves are `video.url` and `video.mime_type`.                                                                      |
...
| `video.url`                                    | String                      | `"gs://bucket/clip.mp4"`                                                                                                      | The URL, object-store URI, or base64 data URI of a video                                                                                                                            |
| `video.mime_type`                              | String                      | `"video/mp4"`                                                                                                                 | The MIME type of the video                                                                                                                                                          |
...
- `llm.<input|output>_messages.<messageIndex>.message.contents.<contentIndex>.message_content.audio.audio.mime_type` - Audio MIME type
...
- `llm.<input|output>_messages.<messageIndex>.message.contents.<contentIndex>.message_content.video.video.url` - Video URL, object-store URI, or base64 data URI
- `llm.<input|output>_messages.<messageIndex>.message.contents.<contentIndex>.message_content.video.video.mime_type` - Video MIME type
