...
| `agent.next_agent`                     | String                      | `1`                                                                        | The name of the next agent in the execution graph.                                                                    |
...
| `graph.node.next_node`                 | String                      | `1`                                                                        | The name of the next node in the in the execution graph.                                                              |
