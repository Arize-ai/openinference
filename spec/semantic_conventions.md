...
| `agent.name`                           | String                      | `"supervisor"`                                                             | The name of the agent that this span represents.                                                                      |
| `agent.step`                           | Integer                     | `1`                                                                        | The step of the current agent in the execution graph.                                                                 |
| `agent.next_agent`                     | String                      | `researcher`                                                               | The name of the next agent in the execution graph.                                                                    |
| `graph.node.name`                      | String                      | `"router"`                                                                 | The name of the current node in the execution graph. Similar to `agent.name` but for general purpose execution graphs |
| `graph.node.step`                      | Integer                     | `1`                                                                        | The step of the current node graph in the execution graph.                                                            |
| `graph.node.next_node`                 | String                      | `search_api`                                                               | The name of the next node in the execution graph.                                                                     |
