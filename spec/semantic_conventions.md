...
| `message_content.type`                         | String                      | `"text"`, `"image"`, `"audio"`, `"file"`, `"reasoning"`, or `"tool_use"`                                                      | The type of the content. Use `"reasoning"` for reasoning/thinking content, including Anthropic `redacted_thinking` blocks. Use `"tool_use"` when a provider returns a tool call as an ordered content part. |
...
| `message_content.audio`                        | Audio Object                | `{"audio.url": "data:audio/wav;base64,..."}`                                                                                  | The audio content of the message, if the type is "audio".                                                                                                                           |
| `message_content.file`                         | File Object                 | `{"file.url": "data:application/pdf;base64,...", "file.name": "report.pdf"}`                                                  | The file content of the message, if the type is "file".                                                                                                                             |
...
| `audio.url`                                    | String                      | `https://storage.com/buckets/1/file.wav`                                                                                      | The url to an audio file (e.x. cloud storage), or a `data:audio/...;base64,` data URI for inline audio                                                                              |
...
| `file.url`                                     | String                      | `s3://bucket/docs/report.pdf`                                                                                                 | The url to a file attached to a message (e.x. cloud storage), or a `data:application/pdf;base64,` data URI for inline files                                                         |
| `file.mime_type`                               | String                      | `application/pdf`                                                                                                             | The mime type of the file                                                                                                                                                           |
| `file.name`                                    | String                      | `report.pdf`                                                                                                                  | The name of the file                                                                                                                                                                |
| `file.id`                                      | String                      | `file-abc123`                                                                                                                 | A provider-assigned id for a file pre-uploaded to the provider (e.x. OpenAI Files API)                                                                                              |
...
- `llm.<input|output>_messages.<messageIndex>.message.contents.<contentIndex>.message_content.type` - Content type (`"text"`, `"image"`, `"audio"`, `"file"`, `"reasoning"`, or `"tool_use"`)
