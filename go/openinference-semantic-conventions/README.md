...
For LLM clients with first-party auto-instrumentation, use [`openinference-instrumentation-openai`](../openinference-instrumentation-openai) (when available) or [`openinference-instrumentation-anthropic`](../openinference-instrumentation-anthropic) (when available) — they call into this package automatically.
